...
Inductive AExp : Set :=
 ...
 | k_HOLE_AExp : AExp
with Array : Set :=
   (* 'const-array(_,_) *) k_label_zqconstzmarrayZLzuzxzuZR : Int ->
                                                              k ->
                                                              Array
 | (* 'store(_,_,_) *) k_label_zqstoreZLzuzxzuzxzuZR : Array ->
                                                       Int ->
                                                       k ->
                                                       Array
with BExp : Set :=
...
with Bool : Set :=
 ...
 | (* 'exists_._ *) k_label_zqexistszuzizu : k_sort_Set ->
                                             Bool ->
                                             Bool
 | (* 'forall_._ *) k_label_zqforallzuzizu : k_sort_Set ->
                                             Bool ->
                                             Bool
with Char : Set :=
with Float : Set :=
...
with kitem : Set :=
 ...
 | (* '#splitedBinder *) k_label_zqzhsplitedBinder : KList ->
                                                     KList ->
                                                     k_sort_Set ->
                                                     kitem
 | (* 'dummy *) k_label_zqdummy : KList -> kitem
 | (* 'freshVariables *) k_label_zqfreshVariables : k_sort_Set ->
                                                    k ->
                                                    kitem
 | (* 'isSymbolicK *) k_label_zqisSymbolicK : List -> kitem
 | (* 'select(_,_) *) k_label_zqselectZLzuzxzuZR : Array ->
                                                   Int ->
                                                   kitem
...
with Stream : Set :=
 ...
 | (* '#parseInput *) k_label_zqzhparseInput : String ->
                                               String ->
                                               Stream
with String : Set :=
...
with TCPError : Set :=
 ...
 | (* '#tcpError(_) *) k_label_zqzhtcpErrorZLzuZR : String ->
                                                    TCPError
